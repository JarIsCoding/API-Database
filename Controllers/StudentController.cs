...
public class StudentController : ControllerBase
{
    ...
    [Route("AddStudent/{studentName}/{studentLast}/{studentHobby}")] // To pass data through Routes add /{parameter name}
    public List<Student> AddStudent(string studentName, string studentLast, string studentHobby)
    {
        return _studentService.AddStudent(studentName, studentLast, studentHobby);
    }
